...
if (isset($_POST['username'])){
  ...
  $password = mysqli_real_escape_string($conn, $password);
    $query = "SELECT * FROM `admin` WHERE username='$username' and password='".hash('sha256', $password)."'";
    ...
    <div class="col-6" style="margin-top:4vh">
        <div class="card shadow">
            <div class="card-body">
                ...
                <input type="text" class="form-control mb-3" id="username" name="username" placeholder="Nom d'utilisateur*">
